...
import com.zl.db.annotation.DbField;
import com.zl.db.annotation.DbTable;
...
public class BaseDao<T> implements IBaseDao<T> {
    ...
    public long insert(T entity) {
        //user 对象 转换为contentValues  new User(1,"zl","password")
    ...
    private List<T> getResult(Cursor cursor, T where) {
        ...
        Object item = null;  //相当于  User user = null
        while (cursor.moveToNext()) {
            try {
                item = where.getClass().newInstance();//相当于  user = new User();
